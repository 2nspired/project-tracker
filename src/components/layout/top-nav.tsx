...
/**
 * App-wide top navigation. Lives at the top of `(main)/layout.tsx` and
 * carries the brand link, primary nav, command-palette search button,
 * MCP catalog trigger, docs link, server-status pill, and theme toggle.
 *
 * The search button opens the command palette via `useCommandPalette()`
 * — must be rendered inside a `<CommandPaletteProvider>`.
 */

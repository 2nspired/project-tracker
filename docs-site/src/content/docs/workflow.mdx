...
description: The core workflow — briefMe → work → saveHandoff → fresh chat. Everything else is detail.
---
...
<Aside type="tip" title="A slash command for this">
	In Claude Code, the `/handoff` slash command calls `saveHandoff` for you — same wrap-up, one keystroke. Other agents that support slash commands can wire up the equivalent.
</Aside>

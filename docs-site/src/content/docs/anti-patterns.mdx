---
title: Anti-patterns
description: The ways people trip themselves up with Project Tracker — and the small adjustments that fix them.
---
...
Keep cards actionable: clear title, ≥1 checklist item, a priority, a tag. The `auditBoard` extended tool will find cards missing these — use it when the board starts feeling noisy. Use the `notes` table (or `scratch` tool) for "I want to remember this but it's not a unit of work yet."

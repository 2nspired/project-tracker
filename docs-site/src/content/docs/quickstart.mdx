...
5. **Start a new chat and run `briefMe`**
	...
	Open a new session with your agent in the connected project. Ask it to run `briefMe`. You'll see a compact primer come back — roughly 300–500 tokens of: the last handoff, changes since then, top work-next candidates, blockers, open decisions.
...
This project is tracked via project-tracker MCP. Call `briefMe()` at the start

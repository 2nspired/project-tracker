...
Project Tracker makes a few opinionated calls that aren't universal. This page explains the *why* behind each one — so if the tool doesn't fit your situation, you can see that clearly instead of fighting it.
